...
function Tab({ type = "primary", to, userId }) {
  ...
  return (
    ...
    >
      <>
        {to === "editor" && (
          <div className="md md:flex md:items-center md:gap-2">
            <svg
            ...
            <span className="hidden font-semibold text-grey md:inline-block">
              Links
            </span>
          </div>
        )}
        ...
        {to === userId && (
          <>
            ...
            <span className="hidden font-semibold text-brand-purple md:inline-block">
              Preview
            </span>
          </>
        )}
